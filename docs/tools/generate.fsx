...
let githubLink = "http://github.com/Update GitHome in build.fsx/Oddjob"

// Specify more information about your project
let info =
  [ "project-name", "Oddjob"
    "project-author", "Erlend Wiig"
    "project-summary", "Engine for uploading files to cdn"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Oddjob" ]
